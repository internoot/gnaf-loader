...
SELECT locality_pid || '_1',
       ...
       ST_Transform(ST_SetSRID(ST_MakePoint(144.96326770, -37.81348464), 4283), 7844) AS geom
...
SELECT locality_pid || '_2',
       ...
       'Y' AS has_boundary,
       'N' AS unique_locality_state,
       ST_Transform(ST_SetSRID(ST_MakePoint(144.97757127, -37.83356762), 4283), 7844) AS geom
  FROM gnaf.localities
  WHERE locality_pid = 'loc9901d119afda';
